...
function App() {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", null, copied ? /* @__PURE__ */ React.createElement("div", {
    ...
    options: {
      strings: ["Short URL Generator", "Type Your URL Below"],
      autoStart: true,
      loop: true
    }
  })), /* @__PURE__ */ React.createElement("p", {
    className: "mt-2 text-left text-1xl text-gray-400"
  }, "URL shortener to make your URL link short and easy 😀.")), /* @__PURE__ */ React.createElement("form", {
    ...
    type: "submit",
    className: disable ? "cursor-not-allowed group disabled w-full flex justify-center py-4 px-5 border border-transparent text-lg font-medium rounded-md text-white bg-gray-300 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500" : "group w-full flex justify-center py-4 px-5 border border-transparent text-lg font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 button bubble-right"
  }, loading ? /* @__PURE__ */ React.createElement("img", {
    src: Loader,
    className: "animate-spin h-6 w-6 mx-auto",
    alt: "loading ..."
  }) : /* @__PURE__ */ React.createElement(React.Fragment, null, "Create a Link")))), /* @__PURE__ */ React.createElement("p", {
    className: "mt-2 text-right text-1xl text-dark-900"
  }, "Created By", /* @__PURE__ */ React.createElement(Typewriter, {
    options: {
      strings: ["AJIT KUMAR PAL", "MCA 4th Sem"],
      autoStart: true,
      loop: true
    }
  })), /* @__PURE__ */ React.createElement("div", null, link !== "" ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("button", {
    type: "button",
