import { c as createCommonjsModule, r as react$1 } from './common/index-4b0af3e2.js';
...
class Options {
    constructor(engine) {
        ...
        __classPrivateFieldSet$1(this, _Options_engine, engine, "f");
        this.autoPlay = true;
    ...
    load(data) {
        ...
        __classPrivateFieldGet$1(this, _Options_engine, "f").plugins.loadOptions(this, data);
        ...
        this.defaultDarkTheme = (_d = __classPrivateFieldGet$1(this, _Options_instances, "m", _Options_findDefaultTheme).call(this, "dark")) === null || _d === void 0 ? void 0 : _d.name;
        this.defaultLightTheme = (_e = __classPrivateFieldGet$1(this, _Options_instances, "m", _Options_findDefaultTheme).call(this, "light")) === null || _e === void 0 ? void 0 : _e.name;
    }
    setTheme(name) {
        if (name) {
            ...
            const mediaMatch = typeof matchMedia !== "undefined" && matchMedia("(prefers-color-scheme: dark)"), clientDarkMode = mediaMatch && mediaMatch.matches, defaultTheme = __classPrivateFieldGet$1(this, _Options_instances, "m", _Options_findDefaultTheme).call(this, clientDarkMode ? "dark" : "light");
            if (defaultTheme) {
    ...
    importPreset(preset) {
        this.load(__classPrivateFieldGet$1(this, _Options_engine, "f").plugins.getPreset(preset));
    }
}
...
class InteractionManager {
    constructor(engine, container) {
        ...
        __classPrivateFieldSet$2(this, _InteractionManager_engine, engine, "f");
        this.externalInteractors = [];
        this.particleInteractors = [];
        this.init();
    }
    init() {
        const interactors = __classPrivateFieldGet$2(this, _InteractionManager_engine, "f").plugins.getInteractors(this.container, true);
        this.externalInteractors = [];
        this.particleInteractors = [];
...
class Particle {
    constructor(engine, id, container, position, overrideOptions, group) {
        ...
        __classPrivateFieldSet$3(this, _Particle_engine, engine, "f");
        this.fill = true;
        this.close = true;
        this.lastPathTime = 0;
        ...
        if (!drawer) {
            drawer = __classPrivateFieldGet$3(this, _Particle_engine, "f").plugins.getShapeDrawer(this.shape);
            if (drawer) {
...
class Particles {
    constructor(engine, container) {
        ...
        this.interactionManager = new InteractionManager(__classPrivateFieldGet$4(this, _Particles_engine, "f"), container);
        const canvasSize = this.container.canvas.size;
        this.linksColors = new Map();
        this.quadTree = new QuadTree(new Rectangle(-canvasSize.width / 4, -canvasSize.height / 4, (canvasSize.width * 3) / 2, (canvasSize.height * 3) / 2), 4);
        this.movers = __classPrivateFieldGet$4(this, _Particles_engine, "f").plugins.getMovers(container, true);
        this.updaters = __classPrivateFieldGet$4(this, _Particles_engine, "f").plugins.getUpdaters(container, true);
    }
    get count() {
    ...
    removeAt(index, quantity = 1, group, override) {
        ...
        for (let i = index; deleted < quantity && i < this.count; i++) {
            ...
            deleted++;
            __classPrivateFieldGet$4(this, _Particles_engine, "f").dispatchEvent("particleRemoved", {
    ...
    pushParticle(position, overrideOptions, group, initializer) {
        try {
            const particle = new Particle(__classPrivateFieldGet$4(this, _Particles_engine, "f"), this.nextId, this.container, position, overrideOptions, group);
            let canAdd = true;
            if (initializer) {
            ...
            this.nextId++;
            __classPrivateFieldGet$4(this, _Particles_engine, "f").dispatchEvent("particleAdded", {
                container: this.container,
                data: {
                    particle,
                },
...
class Container {
    constructor(engine, id, sourceOptions) {
        ...
        __classPrivateFieldSet$5(this, _Container_engine, engine, "f");
        this.fpsLimit = 120;
        this.duration = 0;
        this.lifeTime = 0;
        ...
        this.particles = new Particles(__classPrivateFieldGet$5(this, _Container_engine, "f"), this);
        ...
        this.density = 1;
        this._options = loadContainerOptions(__classPrivateFieldGet$5(this, _Container_engine, "f"));
        this.actualOptions = loadContainerOptions(__classPrivateFieldGet$5(this, _Container_engine, "f"));
        this.eventListeners = new EventListeners(this);
        if (typeof IntersectionObserver !== "undefined" && IntersectionObserver) {
            this.intersectionObserver = new IntersectionObserver((entries) => this.intersectionManager(entries));
        }
        __classPrivateFieldGet$5(this, _Container_engine, "f").dispatchEvent("containerBuilt", { container: this });
    }
    get options() {
    ...
    play(force) {
        ...
        __classPrivateFieldGet$5(this, _Container_engine, "f").dispatchEvent("containerPlay", { container: this });
    ...
    pause() {
        ...
        __classPrivateFieldGet$5(this, _Container_engine, "f").dispatchEvent("containerPaused", { container: this });
    }
    draw(force) {
    ...
    destroy() {
        ...
        this.destroyed = true;
        __classPrivateFieldGet$5(this, _Container_engine, "f").dispatchEvent("containerDestroyed", { container: this });
    }
    exportImg(callback) {
    ...
    stop() {
        ...
        __classPrivateFieldGet$5(this, _Container_engine, "f").dispatchEvent("containerStopped", { container: this });
    }
    ...
    async start() {
        ...
        __classPrivateFieldGet$5(this, _Container_engine, "f").dispatchEvent("containerStarted", { container: this });
        this.play();
    }
    ...
    async init() {
        const shapes = __classPrivateFieldGet$5(this, _Container_engine, "f").plugins.getSupportedShapes();
        for (const type of shapes) {
            const drawer = __classPrivateFieldGet$5(this, _Container_engine, "f").plugins.getShapeDrawer(type);
            if (drawer) {
                this.drawers.set(type, drawer);
            }
        }
        this._options = loadContainerOptions(__classPrivateFieldGet$5(this, _Container_engine, "f"), this._initialSourceOptions, this.sourceOptions);
        this.actualOptions = loadContainerOptions(__classPrivateFieldGet$5(this, _Container_engine, "f"), this._options);
        this.retina.init();
        this.canvas.init();
        ...
        const availablePlugins = __classPrivateFieldGet$5(this, _Container_engine, "f").plugins.getAvailablePlugins(this);
        ...
        if (pathOptions.generator) {
            this.setPath(__classPrivateFieldGet$5(this, _Container_engine, "f").plugins.getPathGenerator(pathOptions.generator));
        }
        __classPrivateFieldGet$5(this, _Container_engine, "f").dispatchEvent("containerInit", { container: this });
        this.particles.init();
        ...
        __classPrivateFieldGet$5(this, _Container_engine, "f").dispatchEvent("particlesSetup", { container: this });
    }
...
class Loader {
    constructor(engine) {
        ...
        __classPrivateFieldSet$6(this, _Loader_engine, engine, "f");
    }
    dom() {
        return __classPrivateFieldGet$6(this, _Loader_engine, "f").domArray;
    }
    domItem(index) {
        const dom = this.dom();
    ...
    async loadOptions(params) {
        ...
        const newItem = new Container(__classPrivateFieldGet$6(this, _Loader_engine, "f"), tagId, currentOptions);
        if (oldIndex >= 0) {
    ...
    addEventListener(type, listener) {
        __classPrivateFieldGet$6(this, _Loader_engine, "f").eventDispatcher.addEventListener(type, listener);
    }
    removeEventListener(type, listener) {
        __classPrivateFieldGet$6(this, _Loader_engine, "f").eventDispatcher.removeEventListener(type, listener);
    }
    dispatchEvent(type, args) {
        __classPrivateFieldGet$6(this, _Loader_engine, "f").eventDispatcher.dispatchEvent(type, args);
    }
}
...
class Plugins {
    constructor(engine) {
        ...
        __classPrivateFieldSet$7(this, _Plugins_engine, engine, "f");
        this.plugins = [];
...
class Engine {
    constructor() {
        ...
        __classPrivateFieldSet$8(this, _Engine_initialized, false, "f");
        __classPrivateFieldSet$8(this, _Engine_loader, new Loader(this), "f");
        this.plugins = new Plugins(this);
    }
    init() {
        if (!__classPrivateFieldGet$7(this, _Engine_initialized, "f")) {
            __classPrivateFieldSet$8(this, _Engine_initialized, true, "f");
        }
    }
    async loadFromArray(tagId, options, index) {
        return __classPrivateFieldGet$7(this, _Engine_loader, "f").load(tagId, options, index);
    }
    async load(tagId, options) {
        return __classPrivateFieldGet$7(this, _Engine_loader, "f").load(tagId, options);
    }
    async set(id, element, options) {
        return __classPrivateFieldGet$7(this, _Engine_loader, "f").set(id, element, options);
    }
    async loadJSON(tagId, pathConfigJson, index) {
        return __classPrivateFieldGet$7(this, _Engine_loader, "f").loadJSON(tagId, pathConfigJson, index);
    }
    async setJSON(id, element, pathConfigJson, index) {
        return __classPrivateFieldGet$7(this, _Engine_loader, "f").setJSON(id, element, pathConfigJson, index);
    }
    setOnClickHandler(callback) {
        __classPrivateFieldGet$7(this, _Engine_loader, "f").setOnClickHandler(callback);
    }
    dom() {
        return __classPrivateFieldGet$7(this, _Engine_loader, "f").dom();
    }
    domItem(index) {
        return __classPrivateFieldGet$7(this, _Engine_loader, "f").domItem(index);
    }
    async refresh() {
    ...
    addEventListener(type, listener) {
        __classPrivateFieldGet$7(this, _Engine_loader, "f").addEventListener(type, listener);
    }
    removeEventListener(type, listener) {
        __classPrivateFieldGet$7(this, _Engine_loader, "f").removeEventListener(type, listener);
    }
    dispatchEvent(type, args) {
        __classPrivateFieldGet$7(this, _Engine_loader, "f").dispatchEvent(type, args);
    }
}
...
var esm = /*#__PURE__*/Object.freeze({
    ...
    noPolygonDataLoaded: noPolygonDataLoaded,
    noPolygonFound: noPolygonFound,
    ...
    AnimatableGradient: AnimatableGradient,
    GradientAngle: GradientAngle,
    GradientColorOpacity: GradientColorOpacity,
    AnimatableGradientColor: AnimatableGradientColor,
    GradientAngleAnimation: GradientAngleAnimation,
    GradientColorOpacityAnimation: GradientColorOpacityAnimation,
    ...
    ParticlesRepulse: ParticlesRepulse,
    Roll: Roll,
    RollLight: RollLight,
    Rotate: Rotate,
    ...
    loadContainerOptions: loadContainerOptions,
