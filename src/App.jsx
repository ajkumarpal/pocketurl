  ...
  return (
    <div>
      ...
      <div className="min-h-screen flex items-center justify-center  py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-lg w-full space-y-8 form-conatiner container demo animated" id="box">
          <div>
...
/>
            ...
            <p className="mt-2 text-left text-1xl text-gray-400">
              URL shortener to make your URL link short and easy 😀.
            </p>
              ...
              <button
                ...
                className={
                  disable
                    ...
                    : 'group w-full flex justify-center py-4 px-5 border border-transparent text-lg font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 button bubble-right'
                }
              >
                {loading ? (
                  <img
          ...
          <p className="mt-2 text-right text-1xl text-dark-900">Created By
          <Typewriter
              options={{
